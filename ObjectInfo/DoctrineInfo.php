...
namespace A2lix\TranslationFormBundle\ObjectInfo;
        ...
        foreach ($assocNames as $assocName) {
            ...
            if ($metadata->isSingleValuedAssociation($assocName)) {
                ...
                $assocsConfigs[$assocName] = [
                    'field_type' => 'A2lix\TranslationFormBundle\Form\Type\AutoFormType',
                    'data_class' => $class,
                    'required' => !$nullable,
                ];
            ...
            $assocsConfigs[$assocName] = [
                ...
                'entry_type' => 'A2lix\TranslationFormBundle\Form\Type\AutoFormType',
                'entry_options' => [
                    'data_class' => $class,
                ],
                'allow_add' => true,
