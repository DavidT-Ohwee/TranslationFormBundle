...
namespace A2lix\TranslationFormBundle\Form\Manipulator;

use A2lix\TranslationFormBundle\ObjectInfo\ObjectInfoInterface;
...
class DefaultManipulator implements FormManipulatorInterface
{
    ...
    public function getFieldsConfig(FormInterface $form)
    {
        ...
        $usuableObjectFieldsConfig = $this->filteringUsuableFields($objectFieldsConfig, array_merge($this->globalExcludedFields, $formOptions['excluded_fields']));
